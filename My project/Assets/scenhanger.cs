...
public class SceneButtonLoader : MonoBehaviour
{
    ...
    public void LoadScene()
    {
        ...
        {
            Debug.LogWarning("Nie wybrano sceny do załadowania.");
        }
    }
    ...
    public class SceneButtonLoaderEditor : Editor
    {
        public override void OnInspectorGUI()
        {
            ...
            selectedIndex = EditorGUILayout.Popup("Scena do załadowania", selectedIndex, sceneNames);
            loader.sceneToLoad = sceneNames[selectedIndex];

            EditorGUILayout.Space();
            if (GUILayout.Button("Załaduj teraz (tylko w edytorze)"))
            {
